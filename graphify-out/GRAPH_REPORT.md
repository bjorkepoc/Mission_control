...
## Corpus Check
- 740 files · ~453,046 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5433 nodes · 18529 edges · 655 communities detected
- Extraction: 39% EXTRACTED · 61% INFERRED · 0% AMBIGUOUS · INFERRED: 11288 edges (avg confidence: 0.6)
...
- `test_delete_where_rolls_back_when_commit_fails()` --calls--> `delete_where()`  [INFERRED]
  /home/clawd/.openclaw/workspace/mission-control/backend/tests/test_db_transaction_safety.py → /home/clawd/.openclaw/workspace/mission-control/backend/app/db/crud.py
- `test_security_headers_middleware_passes_through_non_http_scope()` --calls--> `SecurityHeadersMiddleware`  [INFERRED]
  /home/clawd/.openclaw/workspace/mission-control/backend/tests/test_security_headers_middleware.py → /home/clawd/.openclaw/workspace/mission-control/backend/app/core/security_headers.py

## Communities

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (517): _fetch_task_comment_events(), list_activity(), list_task_comment_feed(), Utilities for recording normalized activity events., Create and attach an activity event row to the current DB session., record_activity(), create_task(), list_boards() (+509 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (529): agentHealthzApiV1AgentHealthzGet(), agentHeartbeatApiV1AgentHeartbeatPost(), agentLeadAskUserViaGatewayMain(), agentLeadCreateAgent(), agentLeadCreateTask(), agentLeadDeleteBoardAgent(), agentLeadNudgeAgent(), agentLeadUpdateAgentSoul() (+521 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (416): ABC, AbstractGatewayMainAgentManager, DefaultGatewayMainAgentManager, GatewayAdminLifecycleService, Gateway admin lifecycle service., Validate that a gateway runtime meets minimum supported version., Abstract manager for gateway-main agent naming/profile behavior., Default naming/profile strategy for gateway-main agents. (+408 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (429): AbstractGatewayMessagingService, ActivityEvent, ActivityEventRead, ActivityTaskCommentFeedItemRead, Activity event model persisted for audit and feed use-cases., Serialized activity event payload returned by activity endpoints., Denormalized task-comment feed item enriched with task and board fields., Activity listing and task-comment feed endpoints. (+421 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (315): _normalize_identity_profile(), normalize_identity_profile(), openEditTaskDialog(), iter_md_files(), main(), normalize_target(), Return markdown files to check.      Policy:     - Always check root contributor, main() (+307 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (230): getListActivityApiV1ActivityGetQueryKey(), getListActivityApiV1ActivityGetQueryOptions(), getListActivityApiV1ActivityGetUrl(), getListTaskCommentFeedApiV1ActivityTaskCommentsGetQueryKey(), getListTaskCommentFeedApiV1ActivityTaskCommentsGetQueryOptions(), getListTaskCommentFeedApiV1ActivityTaskCommentsGetUrl(), getStreamTaskCommentFeedApiV1ActivityTaskCommentsStreamGetQueryKey(), getStreamTaskCommentFeedApiV1ActivityTaskCommentsStreamGetQueryOptions() (+222 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (130): createBoardMemoryApiV1BoardsBoardIdMemoryPost(), deleteBoardChatMemoryApiV1BoardsBoardIdMemoryChatDelete(), getCreateBoardMemoryApiV1BoardsBoardIdMemoryPostMutationOptions(), getCreateBoardMemoryApiV1BoardsBoardIdMemoryPostUrl(), getDeleteBoardChatMemoryApiV1BoardsBoardIdMemoryChatDeleteMutationOptions(), getDeleteBoardChatMemoryApiV1BoardsBoardIdMemoryChatDeleteUrl(), getListBoardMemoryApiV1BoardsBoardIdMemoryGetQueryKey(), getListBoardMemoryApiV1BoardsBoardIdMemoryGetQueryOptions() (+122 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (144): Raise HTTP 403 unless the authenticated actor is a human user (not an agent)., require_user_actor(), _find_agent_for_token(), get_agent_auth_context(), get_agent_auth_context_optional(), Agent authentication helpers for token-backed API access.  This module is used f, Require and validate agent auth token from request headers., Optionally resolve agent auth context from `X-Agent-Token` or `Authorization: Be (+136 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (100): Discrete activity event tied to board/task/agent context., Agent configuration and lifecycle state persisted in the database., Map an approval request to one task (many links per approval allowed)., Approval request and decision metadata for gated operations., QueryModel, Base model mixins and shared SQLModel abstractions., Base SQLModel with a shared query manager descriptor., Persisted memory items associated with a board group. (+92 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (92): Access control helpers for actor-type checks., _is_missing_gateway_agent_error(), _error_payload(), _get_request_id(), _http_exception_exception_handler(), _http_exception_handler(), install_error_handling(), _json_safe() (+84 more)

### Community 10 - "Community 10"
Cohesion: 0.16
Nodes (104): AuthContext, Authenticated user context resolved from inbound auth headers., Reusable FastAPI dependencies for auth and board/task access.  These dependencie, Resolve and require active organization membership for the current user., Require organization-admin membership privileges., Load a board by id or raise HTTP 404., Load a board and enforce actor read access., Load a board and enforce actor write access. (+96 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (71): _build_payload_preview(), _compute_webhook_retry_delay(), _compute_webhook_retry_jitter(), dequeue_webhook_delivery(), dequeue_webhook_delivery_task(), flush_webhook_delivery_queue(), _load_webhook_payload(), _process_single_item() (+63 more)
...
Cohesion: 0.05
Nodes (77): _append_unique_tags(), build_claude_command(), build_codex_command(), _cli_chat_session_tags(), Codex55BridgeConfig, CodexRunResult, _diagnose_only_prompt(), _download_image() (+69 more)
...
Cohesion: 0.06
Nodes (59): _apply_board_update(), _board_group_change_message(), _board_update_message(), BoardBase, BoardCreate, BoardUpdate, create_board(), delete_board() (+51 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (60): _actor(), agent_heartbeat(), ask_user_via_gateway_main(), create_agent(), create_approval(), create_board_memory(), create_task_comment(), delete_board_agent() (+52 more)

### Community 17 - "Community 17"
Cohesion: 0.12
Nodes (54): RuntimeError, GatewayInstalledSkill, _apply_pack_candidate_updates(), _coerce_index_entries(), _collect_pack_skills(), _collect_pack_skills_from_index(), _collect_pack_skills_with_warnings(), MarketplaceSkillActionResponse (+46 more)
...
Cohesion: 0.12
Nodes (44): _cpu_snapshot(), DashboardKpis, DashboardMetrics, DashboardPendingApproval, DashboardPendingApprovals, DashboardRangeSeries, DashboardSeriesPoint, DashboardSeriesSet (+36 more)
...
Cohesion: 0.19
Nodes (20): _agent_role(), _build_activity_route(), _coerce_activity_rows(), _coerce_task_comment_rows(), _feed_item(), _parse_since(), stream_task_comment_feed(), _make_agent() (+12 more)
...
Cohesion: 0.2
Nodes (15): getHealthHealthGetQueryKey(), getHealthHealthGetQueryOptions(), getHealthHealthGetUrl(), getHealthzHealthzGetQueryKey(), getHealthzHealthzGetQueryOptions(), getHealthzHealthzGetUrl(), getReadyzReadyzGetQueryKey(), getReadyzReadyzGetQueryOptions() (+7 more)
...
Cohesion: 0.29
Nodes (10): dashboardMetricsApiV1MetricsDashboardGet(), getDashboardMetricsApiV1MetricsDashboardGetQueryKey(), getDashboardMetricsApiV1MetricsDashboardGetQueryOptions(), getDashboardMetricsApiV1MetricsDashboardGetUrl(), getSystemMetricsApiV1MetricsSystemGetQueryKey(), getSystemMetricsApiV1MetricsSystemGetQueryOptions(), getSystemMetricsApiV1MetricsSystemGetUrl(), systemMetricsApiV1MetricsSystemGet() (+2 more)
...
Cohesion: 0.36
Nodes (4): _AgentStub, _FakeSession, _GatewayStub, test_delete_gateway_main_agent_does_not_require_board_id()
...
## Knowledge Gaps
- **584 isolated node(s):** `Return markdown files to check.      Policy:     - Always check root contributor`, `Migration graph integrity checks for CI.  Checks: - alembic script graph can be`, `Entrypoint for the host-side Codex CLI bridge service.`, `Export the backend OpenAPI schema to a versioned JSON artifact.`, `Generate `openapi.json` from the FastAPI app definition.` (+579 more)
...
- **Thin community `Community 488`** (1 nodes): `BoardsTable.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 489`** (1 nodes): `Build compact watcher status payload for API consumers.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 495`** (1 nodes): `Load trade-journal profile and latest events with bounded output.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 496`** (1 nodes): `Load learner paper-trading and update artifacts for the dashboard.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 497`** (1 nodes): `Build the purpose-built read-only Polymarket operations dashboard payload.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 498`** (1 nodes): `Fetch a followed wallet's current public Polymarket positions on demand.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 499`** (1 nodes): `Persist the copy-trading fixed order size used by the next follow cycle.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 500`** (1 nodes): `Add a wallet to the manually followed list and active pinned roster.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 501`** (1 nodes): `Remove a wallet from active follow lists and block automatic re-adds.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 502`** (1 nodes): `Move a benched wallet back into active manual follow.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 503`** (1 nodes): `Move a benched wallet back into active manual follow.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 504`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 505`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 506`** (1 nodes): `Copy-trading dashboard config.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 507`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 508`** (1 nodes): `Fetch a followed wallet's current public Polymarket positions on demand.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 509`** (1 nodes): `Remove a wallet from active follow lists and block automatic re-adds.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 510`** (1 nodes): `Add a wallet to the manually followed list and active pinned roster.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 511`** (1 nodes): `Remove a wallet from active follow lists and block automatic re-adds.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 512`** (1 nodes): `Move a benched wallet back into active manual follow.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 513`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 514`** (1 nodes): `Resolve watcher root from env override or default path.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 515`** (1 nodes): `Resolve Polymarket scheduled-agent artifact root from env override.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 516`** (1 nodes): `Build compact watcher status payload for API consumers.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 517`** (1 nodes): `Load latest portfolio snapshot from state/portfolio_history if present.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 518`** (1 nodes): `Load strategy signals explainability with fallback to whale_history JSONL.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 519`** (1 nodes): `Load whale-hook explainability snapshot with history fallback.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 520`** (1 nodes): `Load trade-journal profile and latest events with bounded output.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 521`** (1 nodes): `Load learner paper-trading and update artifacts for the dashboard.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 522`** (1 nodes): `Build the purpose-built read-only Polymarket operations dashboard payload.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 523`** (1 nodes): `Fetch a followed wallet's current public Polymarket positions on demand.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 524`** (1 nodes): `Persist the copy-trading fixed order size used by the next follow cycle.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 525`** (1 nodes): `Add a wallet to the manually followed list and active pinned roster.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 526`** (1 nodes): `Remove a wallet from active follow lists and block automatic re-adds.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 528`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 529`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 530`** (1 nodes): `Resolve watcher root from env override or default path.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 531`** (1 nodes): `Resolve Polymarket scheduled-agent artifact root from env override.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 532`** (1 nodes): `Build compact watcher status payload for API consumers.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 533`** (1 nodes): `Load latest portfolio snapshot from state/portfolio_history if present.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 534`** (1 nodes): `Load strategy signals explainability with fallback to whale_history JSONL.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 535`** (1 nodes): `Load whale-hook explainability snapshot with history fallback.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 536`** (1 nodes): `Load trade-journal profile and latest events with bounded output.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 537`** (1 nodes): `Load learner paper-trading and update artifacts for the dashboard.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 538`** (1 nodes): `Build the purpose-built read-only Polymarket operations dashboard payload.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 539`** (1 nodes): `Fetch a followed wallet's current public Polymarket positions on demand.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 540`** (1 nodes): `Persist the copy-trading fixed order size used by the next follow cycle.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 541`** (1 nodes): `Add a wallet to the manually followed list and active pinned roster.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 542`** (1 nodes): `Remove a wallet from active follow lists and block automatic re-adds.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 544`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 545`** (1 nodes): `Resolve Polymarket scheduled-agent artifact root from env override.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 546`** (1 nodes): `Build compact watcher status payload for API consumers.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 547`** (1 nodes): `Build compact watcher status payload for API consumers.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 548`** (1 nodes): `Load latest portfolio snapshot from state/portfolio_history if present.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 549`** (1 nodes): `Load strategy signals explainability with fallback to whale_history JSONL.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 550`** (1 nodes): `Load whale-hook explainability snapshot with history fallback.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 551`** (1 nodes): `Load trade-journal profile and latest events with bounded output.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 552`** (1 nodes): `Load learner paper-trading and update artifacts for the dashboard.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 553`** (1 nodes): `Build the purpose-built read-only Polymarket operations dashboard payload.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 554`** (1 nodes): `Fetch a followed wallet's current public Polymarket positions on demand.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 555`** (1 nodes): `Persist the copy-trading fixed order size used by the next follow cycle.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 559`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 560`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 568`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 569`** (1 nodes): `Fetch a followed wallet's current public Polymarket positions on demand.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 570`** (1 nodes): `Persist the copy-trading fixed order size used by the next follow cycle.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 571`** (1 nodes): `Add a wallet to the manually followed list and active pinned roster.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 572`** (1 nodes): `Remove a wallet from active follow lists and block automatic re-adds.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 573`** (1 nodes): `Move a benched wallet back into active manual follow.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 574`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 575`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 576`** (1 nodes): `Fetch a followed wallet's current public Polymarket positions on demand.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 577`** (1 nodes): `Persist the copy-trading fixed order size used by the next follow cycle.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 578`** (1 nodes): `Add a wallet to the manually followed list and active pinned roster.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 579`** (1 nodes): `Remove a wallet from active follow lists and block automatic re-adds.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 580`** (1 nodes): `Move a benched wallet back into active manual follow.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 581`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 582`** (1 nodes): `Fetch a followed wallet's current public Polymarket positions on demand.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 583`** (1 nodes): `Persist the copy-trading fixed order size used by the next follow cycle.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 584`** (1 nodes): `Add a wallet to the manually followed list and active pinned roster.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 585`** (1 nodes): `Remove a wallet from active follow lists and block automatic re-adds.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 586`** (1 nodes): `Move a benched wallet back into active manual follow.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 587`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 588`** (1 nodes): `Resolve Polymarket scheduled-agent artifact root from env override.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 589`** (1 nodes): `Load latest portfolio snapshot from state/portfolio_history if present.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 590`** (1 nodes): `Load strategy signals explainability with fallback to whale_history JSONL.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 591`** (1 nodes): `Load whale-hook explainability snapshot with history fallback.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 592`** (1 nodes): `Load trade-journal profile and latest events with bounded output.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 593`** (1 nodes): `Load learner paper-trading and update artifacts for the dashboard.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 594`** (1 nodes): `Build the purpose-built read-only Polymarket operations dashboard payload.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 595`** (1 nodes): `Fetch a followed wallet's current public Polymarket positions on demand.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 596`** (1 nodes): `Persist the copy-trading fixed order size used by the next follow cycle.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 597`** (1 nodes): `Add a wallet to the manually followed list and active pinned roster.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 598`** (1 nodes): `Move a benched wallet back into active manual follow.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 600`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 601`** (1 nodes): `Request to add a manually followed Polymarket wallet.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 602`** (1 nodes): `Manual follow-list update result.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 603`** (1 nodes): `Request to update copy-trading dashboard config.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 604`** (1 nodes): `Request to update copy-trading dashboard config.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 605`** (1 nodes): `Copy-trading dashboard config.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 606`** (1 nodes): `Resolve watcher root from env override or default path.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 607`** (1 nodes): `Load latest portfolio snapshot from state/portfolio_history if present.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 608`** (1 nodes): `Load strategy signals explainability with fallback to whale_history JSONL.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 609`** (1 nodes): `Load whale-hook explainability snapshot with history fallback.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 610`** (1 nodes): `Load trade-journal profile and latest events with bounded output.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 611`** (1 nodes): `Load learner paper-trading and update artifacts for the dashboard.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 612`** (1 nodes): `Build the purpose-built read-only Polymarket operations dashboard payload.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 613`** (1 nodes): `Fetch a followed wallet's current public Polymarket positions on demand.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 614`** (1 nodes): `Persist the copy-trading fixed order size used by the next follow cycle.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 615`** (1 nodes): `Add a wallet to the manually followed list and active pinned roster.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 616`** (1 nodes): `Remove a wallet from active follow lists and block automatic re-adds.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 617`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 618`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 619`** (1 nodes): `Resolve watcher root from env override or default path.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 625`** (1 nodes): `Build the purpose-built read-only Polymarket operations dashboard payload.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 626`** (1 nodes): `Fetch a followed wallet's current public Polymarket positions on demand.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 627`** (1 nodes): `Persist the copy-trading fixed order size used by the next follow cycle.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 628`** (1 nodes): `Add a wallet to the manually followed list and active pinned roster.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 629`** (1 nodes): `Remove a wallet from active follow lists and block automatic re-adds.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 630`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 631`** (1 nodes): `Follow-list removal result.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 632`** (1 nodes): `Copy-trading dashboard config.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 633`** (1 nodes): `Resolve watcher root from env override or default path.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 634`** (1 nodes): `Resolve Polymarket scheduled-agent artifact root from env override.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 635`** (1 nodes): `Build compact watcher status payload for API consumers.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 636`** (1 nodes): `Load latest portfolio snapshot from state/portfolio_history if present.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 637`** (1 nodes): `Load strategy signals explainability with fallback to whale_history JSONL.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 638`** (1 nodes): `Load whale-hook explainability snapshot with history fallback.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 639`** (1 nodes): `Load trade-journal profile and latest events with bounded output.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 640`** (1 nodes): `Load learner paper-trading and update artifacts for the dashboard.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 641`** (1 nodes): `Build the purpose-built read-only Polymarket operations dashboard payload.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 642`** (1 nodes): `Persist the copy-trading fixed order size used by the next follow cycle.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 643`** (1 nodes): `Add a wallet to the manually followed list and active pinned roster.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 644`** (1 nodes): `Remove a wallet from active follow lists and block automatic re-adds.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 645`** (1 nodes): `Build account total view: positions + cash when cash is present in state.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 646`** (1 nodes): `Resolve watcher root from env override or default path.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 647`** (1 nodes): `Resolve Polymarket scheduled-agent artifact root from env override.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 648`** (1 nodes): `Build compact watcher status payload for API consumers.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 649`** (1 nodes): `Load latest portfolio snapshot from state/portfolio_history if present.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 650`** (1 nodes): `Load strategy signals explainability with fallback to whale_history JSONL.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 651`** (1 nodes): `Load whale-hook explainability snapshot with history fallback.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 652`** (1 nodes): `Load trade-journal profile and latest events with bounded output.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 653`** (1 nodes): `Load learner paper-trading and update artifacts for the dashboard.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `get()` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 24`, `Community 26`, `Community 31`?**
  _High betweenness centrality (0.318) - this node is a cross-community bridge._
- **Why does `customFetch()` connect `Community 1` to `Community 35`, `Community 4`, `Community 5`, `Community 6`, `Community 28`?**
  _High betweenness centrality (0.255) - this node is a cross-community bridge._
- **Why does `connect()` connect `Community 6` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 7`, `Community 9`, `Community 12`, `Community 22`, `Community 25`?**
...
- **Are the 238 inferred relationships involving `get()` (e.g. with `_run()` and `test_agent_can_fetch_webhook_payload()`) actually correct?**
  _`get()` has 238 INFERRED edges - model-reasoned connections that need verification._